...
class AsistenciasTab(ttk.Frame):
    """
    Módulo de listas de asistencia.
    ...
    Flujo general:
    - seleccionar período / curso / materia / docente / fecha
    - cargar estudiantes del grupo
    - clasificar en asistentes / ausentes
    - guardar
    - consultar listas históricas
    - abrir popup de detalle
    - cargar una lista a edición
    """
    ...
    def _build_tab_registro(self):
        self.tab_registro.rowconfigure(2, weight=1)
        self.tab_registro.columnconfigure(0, weight=1)

        # -----------------------------------------------------
        # Filtros académicos
        # -----------------------------------------------------
        filtros = ttk.LabelFrame(self.tab_registro, text="Datos de la Lista")
        ...
        self.entry_fecha.bind("<<DateEntrySelected>>", self._on_fecha_change)
        ...
        # Resumen superior
        # -----------------------------------------------------
        resumen = ttk.LabelFrame(self.tab_registro, text="Resumen del Grupo")
        ...
        # Cuerpo principal
        # -----------------------------------------------------
        body = ttk.Frame(self.tab_registro)
        ...
        # -----------------------------------------------------
        acciones = ttk.Frame(self.tab_registro)
    ...
    def _build_tab_consulta(self):
        ...
        # Filtros consulta
        # -----------------------------------------------------
        filtros = ttk.LabelFrame(self.tab_consulta, text="Filtros de Consulta")
        filtros.grid(row=0, column=0, sticky="ew", padx=5, pady=5)
        ...
        # Grilla consulta
        # -----------------------------------------------------
        grid_frame = ttk.Frame(self.tab_consulta)
        ...
        # Resumen selección
        # -----------------------------------------------------
        resumen = ttk.LabelFrame(self.tab_consulta, text="Resumen de la Lista Seleccionada")
        ...
        # Acciones consulta
        # -----------------------------------------------------
        acciones = ttk.Frame(self.tab_consulta)
        acciones.grid(row=3, column=0, sticky="ew", padx=5, pady=(0, 5))
    ...
    def _load_context_and_edit(self, item: dict):
        """
    ...
    def _cargar_desde_consulta_a_edicion(self):
        ...
        self._load_context_and_edit(item)
    ...
    # =========================================================
    # Utilidad opcional: cargar desde consulta silenciosamente
    # =========================================================
